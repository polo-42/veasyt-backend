...
class FurnitureResource(BaseResource):
    ...
    def get(id):
        ...
        request = f"""
            SELECT c.id_meuble_client, quantite, d.id_meuble_catalogue, c.id_piece, id_adresse_dechargement, est_avance
        ...
        if custom == 0:
            ...
            request = f"""
                SELECT id_meuble_client_avance, poids, largeur, longueur, hauteur, emballage, deballage, demontage, remontage, infos_supplementaires, id_meuble_catalogue, id_meuble_client
                FROM Meuble_avance
            ...
            return FurnitureResource(default[0],default[1],custom[10],default[3],custom[9],custom_data)
